...
# --- four banked weekly snapshots (oldest first): enough history for the
#     term line to switch on, and for every strip to tell its story — note
#     the Angles slide (green → amber → red), the risk read made visible.
_SUBJ_OF = {
    "Linear equations": "Maths", "Fractions of amounts": "Maths",
    "Angles on parallel lines": "Maths", "Solving equations with brackets": "Maths",
    "States of matter": "Science", "The circulatory system": "Science",
    "The respiratory system": "Science",
    "Causes of the First Crusade": "History",
    "Key figures of the Crusades": "History", "The People's Crusade": "History",
    "Persuasive techniques": "English", "Language devices": "English",
}
SNAPSHOTS = [
    {"week_of": "2026-08-03", "subjects": _SUBJ_OF,
     "topics": {"Linear equations": "shaky", "Fractions of amounts": "developing",
                "Angles on parallel lines": "developing",
                "States of matter": "developing",
                "Causes of the First Crusade": "developing",
                "Persuasive techniques": "untested"}},
    {"week_of": "2026-08-10", "subjects": _SUBJ_OF,
     "topics": {"Linear equations": "developing", "Fractions of amounts": "solid",
                "Angles on parallel lines": "shaky",
                "States of matter": "solid",
                "Causes of the First Crusade": "developing",
                "Key figures of the Crusades": "untested",
                "Persuasive techniques": "developing"}},
    {"week_of": "2026-08-17", "subjects": _SUBJ_OF,
     "topics": {"Linear equations": "developing", "Fractions of amounts": "solid",
                "Angles on parallel lines": "shaky",
                "States of matter": "solid",
                "Causes of the First Crusade": "solid",
                "Key figures of the Crusades": "developing",
                "The circulatory system": "untested",
                "Persuasive techniques": "developing"}},
    {"week_of": "2026-08-24", "subjects": _SUBJ_OF,
     "topics": {"Linear equations": "solid", "Fractions of amounts": "solid",
                "Angles on parallel lines": "REPAIR",
                "Solving equations with brackets": "shaky",
                "States of matter": "solid",
                "The circulatory system": "developing",
                "The respiratory system": "developing",
                "Causes of the First Crusade": "solid",
                "Key figures of the Crusades": "developing",
                "The People's Crusade": "REPAIR",
                "Persuasive techniques": "developing",
                "Language devices": "untested"}},
]
