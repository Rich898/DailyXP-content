...
def system_prompt(legends, today, hsie, has_base):
    ...
    return (
        ...
        "Australian short forms COUNT as explicit: \"17/9\" or \"Thurs 17/9\" "
        "means 17 September (day/month; assume 2026 when the year is "
        "omitted), and \"10th September\" is explicit too. Week-by-week "
        "homepage tables are a PRIME source of assessment dates — scan them "
        "for entries like \"Term 3 Assessment\". NEVER derive a date from "
        "purely relative phrases (\"Week 6\", \"Thursday\", \"next week\") — "
        "in that case leave date null and put the phrase in "
